...
I. Release Notes:
  ...
  This release of the SimpleDB system is Version 2.7, which was uploaded
  on September 1, 2008.  This release updates Version 2.6 in three ways:

    * All reported bugs are fixed.
    * The code has been cleaned up for readability.
    * The simpledb.remote package is now compatible with JDBC 4.0.
